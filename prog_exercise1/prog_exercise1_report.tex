...
\problemAnswer{
Data is maintained on leaf nodes and the discriminant values are maintained on the internal nodes of the tree. An internal node has two values. The first value represents the largest value in the left subtree and the second value represents the largest value in the middle subtree if it exists.
